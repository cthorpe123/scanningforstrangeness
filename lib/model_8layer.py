...
class UNet_8layer(nn.Module):
    def __init__(self, in_dim, n_classes, depth=8, n_filters=16, drop_prob=0.1, y_range = None, kernel_size=3):
        super(UNet_8layer, self).__init__()
        ...
        self.ds_conv_8 = common.ConvBlock(64 * n_filters, 128 * n_filters, k_size=kernel_size)
        ...
        self.ds_maxpool_8 = common.maxpool()
        ...
        self.ds_dropout_8 = common.dropout(drop_prob)

        self.bridge = common.ConvBlock(128 * n_filters, 256 * n_filters, k_size=kernel_size)

        self.us_tconv_8 = common.TransposeConvBlock(256 * n_filters, 128 * n_filters, k_size=kernel_size)
        ...
        self.us_conv_8 = common.ConvBlock(256 * n_filters, 128 * n_filters, k_size=kernel_size)
        ...
        self.us_dropout_8 = common.dropout(drop_prob)
    ...
    def forward(self, x):
        ...
        res = self.ds_conv_8(res); conv_stack_8 = res.clone()
        res = self.ds_maxpool_8(res)
        res = self.ds_dropout_8(res)

        res = self.bridge(res)

        res = self.us_tconv_8(res)
        res = torch.cat([res, conv_stack_8], dim=1)
        res = self.us_dropout_8(res)
        res = self.us_conv_8(res)
