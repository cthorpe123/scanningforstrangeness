...
class UNet_6layer(nn.Module):
    def __init__(self, in_dim, n_classes, depth=6, n_filters=16, drop_prob=0.1, y_range = None, kernel_size=3):
        super(UNet_6layer, self).__init__()
        ...
        self.bridge = common.ConvBlock(32 * n_filters, 64 * n_filters, k_size=kernel_size)
