...
class UNet_5layer(nn.Module):
    def __init__(self, in_dim, n_classes, depth=5, n_filters=16, drop_prob=0.1, y_range = None, kernel_size=3):
        ...
        self.bridge = common.ConvBlock(16 * n_filters, 32 * n_filters, k_size=kernel_size)
